    ...
    <footer className="bg-neutral-900 text-white px-6 md:px-20 py-10">
      <div className="flex flex-col lg:flex-row justify-between gap-10">
        <div className="max-w-2xl space-y-3">
          ...
          <p className="text-[clamp(28px,4vw,60px)] font-bold leading-tight">
          ...
          <div>
            <a
              href="#contact"
              className="inline-block px-6 py-3 border border-white rounded-full hover:bg-white hover:text-black transition text-sm"
            >
              Start a Project {"->"} 
            </a>
          </div>
      ...
      <div className="mt-16 border-t border-white/10 pt-4 flex flex-col md:flex-row justify-between text-xs text-gray-500 gap-2">
        <p>
          &copy; {new Date().getFullYear()} {content.brandName || "Portfolio"}
        </p>
        <p>Built with MERN</p>
      </div>
    </footer>
