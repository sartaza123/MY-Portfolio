  ...
  return (
    <div className="animate-fade-up" style={{ maxWidth: 720 }}>
      ...
      <form onSubmit={handleSubmit} className="glass form-card">
        ...
        <div className="form-actions"><Button type="button" variant="secondary" onClick={() => navigate('/projects')}>Cancel</Button><Button type="submit" loading={saving}>Update Project</Button></div>
      </form>
    </div>
  );
};
